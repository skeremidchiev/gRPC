...
func Test_Success(t *testing.T) {
	...
	comm.RegisterCommServiceServer(grpcServer, NewServer(&mockServerStorage{}))
...
func Test_Error_Cases(t *testing.T) {
	...
	grpcServer := grpc.NewServer()
	comm.RegisterCommServiceServer(grpcServer, NewServer(&mockServerStorageErrors{}))
...
func clientCalls(t *testing.T) {
	cl := client.NewClient(&mockClientStorage{})
	...
	cl = client.NewClient(&mockClientStorageErrors{})
